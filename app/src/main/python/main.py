...
# Build command
# pyinstaller --onefile --add-data "images;images" --add-data "audiofiles;audiofiles" --add-data "db_test.json;." --add-data "python_gui.py;." --add-data "python_gui2.py;." main.py --exclude-module "PySide6" --icon=images/unolingo_P64_icon.ico --windowed
